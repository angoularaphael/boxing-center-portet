  ...
  root.innerHTML = `
    <button type="button" class="bcp-chat__launcher" id="bcp-chat-launcher" aria-label="Ouvrir l’assistant Boxing Center">
      <span class="bcp-chat__launcher-icon" aria-hidden="true">
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none"><mask id="bc-m-portet" maskUnits="userSpaceOnUse"><rect width="24" height="24" fill="#fff"/><path d="M7.4 8.6 11.0 9.9 11.0 11.7 7.4 10.3Z" fill="#000"/><path d="M16.6 8.6 13.0 9.9 13.0 11.7 16.6 10.3Z" fill="#000"/><rect x="10.1" y="14.8" width="3.8" height="1.4" rx=".65" fill="#000"/></mask><path d="M4.4 12.9a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="currentColor"/><path d="M19.6 12.9a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="currentColor"/><path d="M12 .9 20.4 7.4v7.2c0 1.9-1 3.3-2.7 4.1l.9 3.1a.55.55 0 0 1-.8.63l-3.6-2.2a11 11 0 0 1-2.2.2c-4.6 0-8.4-2.3-8.4-5.9V7.4Z" fill="currentColor" mask="url(#bc-m-portet)"/></svg>
      </span>
  ...
  async function openPanel() {
    ...
    if (!opened) {
      ...
      const ACCUEILS: Record<string, [string, string, string[]]> = {
        home: ["Bonjour 👋 Moi c’est Gus. Je vois que vous découvrez la salle.",
        ...
        tarifs: ["Bonjour 👋 Moi c’est Gus. Je vois que vous comparez les tarifs.", "La saison est à 259 € comptant au lieu de 400 € — 12 mois, les 5 salles ; un 4× peut être proposé par PayPal selon disponibilité et éligibilité. Sans engagement, l’offre rentrée est à 29 € par personne toutes les 4 semaines. Je vous détaille laquelle ?", ["saison", "offre", "tarifs"]],
        ...
        "premiere-seance": ["Bonjour 👋 Moi c’est Gus. Je vois que vous préparez votre première séance.", "Aucun niveau demandé, pas de sparring imposé. Une question ?", ["saison", "offre", "essai"]],
