...
const DEF_SITE = {
  ...
  phone: "09 56 65 37 82",
  phoneHref: "+33956653782",
...
export interface NetworkSalle {
  ...
  phoneHref: string;
  mapsUrl: string;
  /** le vrai site du club (Eddy, 13/09 : chaque salle mène à SON site) */
  site: string;
  features: string[];
}

export const NETWORK_SALLES: NetworkSalle[] = [
  { id: "portet", name: "Boxing Center Portet-sur-Garonne", isFlagship: true, address: "61 route d'Espagne, 31120 Portet-sur-Garonne", phone: "09 56 65 37 82", phoneHref: "+33956653782", mapsUrl: "https://maps.google.com/?q=61%20route%20d'Espagne%2031120%20Portet-sur-Garonne", site: "https://boxing-center-portet.fr/", features: ["Le club phare", "600 m² dédiés au combat", "Ring de boxe anglaise", "Cage MMA & prépa physique"] },
  { id: "saint-cyprien", name: "Boxing Center Saint-Cyprien", address: "11 rue Sainte-Lucie, 31300 Toulouse", phone: "09 39 03 67 48", phoneHref: "+33939036748", mapsUrl: "https://maps.google.com/?q=11%20rue%20Sainte-Lucie%2031300%20Toulouse", site: "https://club-boxe-toulouse.com/", features: ["Proche métro République", "Espace combat complet", "Sacs de frappe", "Cardio training"] },
  { id: "minimes", name: "Boxing Center Minimes", address: "12 rue de Fenouillet, 31200 Toulouse", phone: "09 39 03 67 48", phoneHref: "+33939036748", mapsUrl: "https://maps.google.com/?q=12%20rue%20de%20Fenouillet%2031200%20Toulouse", site: "https://boxe-toulouse.com/", features: ["Barrière de Paris", "Ring de boxe & cage MMA", "Tatamis de combat", "Préparation physique"] },
  { id: "ramonville", name: "Boxing Center Ramonville", address: "33 rue des Ormes, 31520 Ramonville-Saint-Agne", phone: "09 39 03 67 48", phoneHref: "+33939036748", mapsUrl: "https://maps.google.com/?q=33%20rue%20des%20Ormes%2031520%20Ramonville-Saint-Agne", site: "https://mmatoulouse.com/", features: ["Ring de boxe", "Zone sacs de frappe", "Cardio training", "Musculation libre"] },
  { id: "etats-unis", name: "Boxing Center États-Unis", address: "388 avenue des États-Unis, 31200 Toulouse", phone: "09 39 03 67 48", phoneHref: "+33939036748", mapsUrl: "https://maps.google.com/?q=388%20avenue%20des%20%C3%89tats-Unis%2031200%20Toulouse", site: "https://clubmma.fr/", features: ["1 200 m² (3 zones)", "Grand ring de boxe", "Cage MMA complète", "Sacs de frappe"] },
];
